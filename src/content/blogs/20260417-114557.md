...
> 卡池中有 $m\in\mathbb{N}^*$ 张价值为 $(a_i)_{i=0}^{m-1}\in(\mathbb{N}^*)^m$ 的 A 类卡和 $n$ 张价值为 $(b_i)_{i=0}^{n-1}\in(\mathbb{N}^*)^n$ 的 B 类卡。现在进行不放回随机抽卡，每张卡被抽中的概率正比于其价值，求抽出的总卡数的期望模 $998244353$。
>
